...
DriverSpecs.mock_driver "Sony::Camera::VISCA" do
  ...
  should_send Bytes[0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x01]
  responds Bytes[0x02, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x01]

  # clear the interface socket
  puts "Testing interface clear"
  should_send Bytes[0x01, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x01, 0x81, 0x01, 0x00, 0x01, 0xFF]
  responds Bytes[0x01, 0x11, 0x00, 0x03, 0x00, 0x00, 0x00, 0x01, 0x90, 0x50, 0xFF]

  puts "Testing camera go-home"
  exec :home
  should_send Bytes[0x01, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x02, 0x81, 0x01, 0x06, 0x04, 0xFF]
  responds Bytes[0x01, 0x11, 0x00, 0x03, 0x00, 0x00, 0x00, 0x02, 0x90, 0x40, 0xFF]
  ...
  should_send Bytes[0x01, 0x10, 0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x81, 0x09, 0x06, 0x12, 0xFF]
  responds Bytes[0x01, 0x11, 0x00, 0x03, 0x00, 0x00, 0x00, 0x03, 0x90, 0x40, 0xFF]
  responds Bytes[0x01, 0x11, 0x00, 0x0B, 0x00, 0x00, 0x00, 0x03, 0x90, 0x50,
  ...
  should_send Bytes[0x01, 0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x04, 0x81, 0x01,
    0x06, 0x02,
    0x0F, 0x00,             # speed
  ...
  responds Bytes[0x01, 0x11, 0x00, 0x03, 0x00, 0x00, 0x00, 0x04, 0x90, 0x50, 0xFF]

  # Should then query the current camera position
  puts "Should query pan tilt position"
  should_send Bytes[0x01, 0x10, 0x00, 0x05, 0x00, 0x00, 0x00, 0x05, 0x81, 0x09, 0x06, 0x12, 0xFF]
  responds Bytes[0x01, 0x11, 0x00, 0x03, 0x00, 0x00, 0x00, 0x05, 0x90, 0x40, 0xFF]
  responds Bytes[0x01, 0x11, 0x00, 0x0B, 0x00, 0x00, 0x00, 0x05, 0x90, 0x50,
    0x03, 0x04, 0x05, 0x06, # pan pos
    0x07, 0x08, 0x09, 0x00, # tilt pos
    0xFF,
  ]
  ...
  exec(:zoom_to, 25.0)
  should_send Bytes[0x01, 0x00, 0x00, 0x09, 0x00, 0x00, 0x00, 0x06, 0x81, 0x01,
    0x04, 0x47,
    0x01, 0x00, 0x00, 0x00, # zoom value
    0xFF,
  ]
  responds Bytes[0x01, 0x11, 0x00, 0x03, 0x00, 0x00, 0x00, 0x06, 0x90, 0x40, 0xFF]
  responds Bytes[0x01, 0x11, 0x00, 0x03, 0x00, 0x00, 0x00, 0x06, 0x90, 0x50, 0xFF]

  # Should then query the current camera zoom level
  puts "Should query zoom level"
  should_send Bytes[0x01, 0x10, 0x00, 0x05, 0x00, 0x00, 0x00, 0x07, 0x81, 0x09, 0x04, 0x47, 0xFF]
  responds Bytes[0x01, 0x11, 0x00, 0x03, 0x00, 0x00, 0x00, 0x07, 0x90, 0x40, 0xFF]
  responds Bytes[0x01, 0x11, 0x00, 0x07, 0x00, 0x00, 0x00, 0x07, 0x90, 0x50,
