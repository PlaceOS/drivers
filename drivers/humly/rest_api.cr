...
module Humly
  class RestApiDriver < PlaceOS::Driver
    ...
    def login
      ...
      if response.success?
        result = Humly::RestApi::ApiResponse(Humly::RestApi::LoginResponse).from_json(response.body)
    ...
    def create_client_group(name : String, description : String? = nil)
      ...
      if response.success?
        result = Humly::RestApi::ApiResponse(Humly::RestApi::ClientGroup).from_json(response.body)
        if result.status == "success" && result.data
    ...
    def get_users(limit : Int32 = 50, offset : Int32 = 0)
      ...
      if response.success?
        result = Humly::RestApi::ApiResponse(Array(Humly::RestApi::User)).from_json(response.body)
        if result.status == "success" && result.data
    ...
    def create_integration_user(email : String, name : String)
      ...
      if response.success?
        result = Humly::RestApi::ApiResponse(Humly::RestApi::User).from_json(response.body)
        if result.status == "success" && result.data
    ...
    def get_rooms(limit : Int32 = 50, offset : Int32 = 0, sort : String? = nil)
      ...
      if response.success?
        result = Humly::RestApi::ApiResponse(Array(Humly::RestApi::Room)).from_json(response.body)
        if result.status == "success" && result.data
    ...
    def get_desks(limit : Int32 = 50, offset : Int32 = 0, sort : String? = nil)
      ...
      if response.success?
        result = Humly::RestApi::ApiResponse(Array(Humly::RestApi::Desk)).from_json(response.body)
        if result.status == "success" && result.data
    ...
    def get_bookings(limit : Int32 = 50, offset : Int32 = 0, sort : String? = nil)
      ...
      if response.success?
        result = Humly::RestApi::ApiResponse(Array(Humly::RestApi::Booking)).from_json(response.body)
        if result.status == "success" && result.data
    ...
    def create_booking(start_time : String, end_time : String, resource_id : String, title : String? = nil, description : String? = nil)
      ...
      if response.success?
        result = Humly::RestApi::ApiResponse(Humly::RestApi::Booking).from_json(response.body)
        if result.status == "success" && result.data
    ...
    def get_structures(limit : Int32 = 50, offset : Int32 = 0)
      ...
      if response.success?
        result = Humly::RestApi::ApiResponse(Array(Humly::RestApi::Country)).from_json(response.body)
        if result.status == "success" && result.data
    ...
    def get_devices(limit : Int32 = 50, offset : Int32 = 0)
      ...
      if response.success?
        result = Humly::RestApi::ApiResponse(Array(Humly::RestApi::Device)).from_json(response.body)
        if result.status == "success" && result.data
    ...
    def get_sensors(limit : Int32 = 50, offset : Int32 = 0)
      ...
      if response.success?
        result = Humly::RestApi::ApiResponse(Array(Humly::RestApi::Sensor)).from_json(response.body)
        if result.status == "success" && result.data
